...
import { Popover } from './SelectText';
  ...
  return (
    <div className=" flex flex-col justify-center ">
      {props.messages.length == 0 ? (
        <div className="flex flex-col items-center justify-center gap-y-2 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2">
            ...
            <div key={id} className="flex flex-col">
              {id % 2 === 0 ? (
                <div className="mb-2">
                  ...
                  {props.loading && (
                    <div className=" me-2 text-sm font-medium text-gray-900 rounded-lg inline-flex items-center">
                      <svg
                        aria-hidden="true"
                        role="status"
                      ...
                      <span className="italic text-primary opacity-60 animate-pulse">
                        Thinking...
                      </span>
                    </div>
                  )}
